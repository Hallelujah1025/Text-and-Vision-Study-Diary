...
movie_data = load_files(r"D:\STUDY\Text and Vision Intelligence\CJLU day 5\txt_sentoken") # folder containing the 2 categories of documents in individual folders.
# loads the data from both "neg" and "pos" folders into the X variable, while the target categories are stored in y
# X is a list of 2000 string type elements where each element corresponds to single user review
# y is a numpy array of size 2000
...
#-------------------------------------------------------------------------------------------------------- one: Multinomial Naive Bayes Classifier
...
#-------------------------------------------------------------------------------------------------------- three: Decision Tree Classifier
